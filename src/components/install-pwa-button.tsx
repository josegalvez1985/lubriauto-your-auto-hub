          ...
          <div className="w-full max-w-sm rounded-2xl bg-card p-6 shadow-[var(--shadow-card)]"
            ...
            <div className="flex items-start justify-between">
              <h3 className="font-bold text-lg text-foreground">
                {ios ? "Instalar en iPhone / iPad" : "Instalar la app"}
              </h3>
            ...
            {ios ? (
              ...
              <ol className="mt-4 space-y-4 text-sm text-muted-foreground">
                <li className="flex items-center gap-3">
                  ...
                  Abre el menú del navegador (<strong className="text-foreground">⋮</strong> arriba a la derecha).
                </li>
                <li className="flex items-center gap-3">
                  <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-muted">
                    <Download className="h-4 w-4" />
                  </span>
                  Selecciona <strong className="text-foreground">Instalar app</strong> (o "Instalar LubriAuto").
                </li>
              </ol>
            )}
          </div>
